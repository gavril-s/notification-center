...
-- +migrate Down
DROP TABLE IF EXISTS sources.audit_log CASCADE;
DROP TABLE IF EXISTS sources.campaigns CASCADE;
DROP TABLE IF EXISTS sources.recurrence_rules CASCADE;
DROP TABLE IF EXISTS sources.contact_group_members CASCADE;
DROP TABLE IF EXISTS sources.contact_groups CASCADE;
DROP TABLE IF EXISTS sources.templates CASCADE;
DROP TABLE IF EXISTS sources.sender_credentials CASCADE;
DROP TABLE IF EXISTS sources.sender_operators CASCADE;
DROP TABLE IF EXISTS sources.senders CASCADE;
DROP SCHEMA IF NOT EXISTS sources CASCADE;